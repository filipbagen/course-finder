...
export function CourseCarousel() {
  ...
  if (loading) {
    return (
      <div className="relative my-10 hidden overflow-hidden text-left md:block lg:block">
        ...
        <div className="skewAnimation grid grid-cols-1 gap-7 sm:h-[500px] sm:grid-cols-2">

    ...
    try {
      ...
      if (!authStatus.isAuthenticated) {
        ...
        try {
          ...
          if (refreshResult.success && refreshResult.session) {
            console.log('Auth: Session refreshed successfully, rechecking auth')
      ...
      if (userData) {
        ...
        try {
          ...
          console.error('Auth: Error refreshing session after API failures:', e)
        }
    ...
    const initialize = async () => {
      ...
      try {
        const { initializeTokenManager } =
          await import('@/lib/supabase/tokenManager')
